...
export default function ExpenseForm() {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) =>{
        ...
        //Valida no pasarse del presupuesto limite
    ...
    <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col gap-2">
            ...
            <input 
                ...
                id="amount" 
                className="bg-slate-100 p-2"
                placeholder="Ingrese cantidad.Ej:200"
        ...
        <div className="flex flex-col gap-2">
            ...
            <input 
                type="submit"
                className="w-full bg-blue-600 font-black p-2 text-white 
                        text-center rounded-lg uppercase cursor-pointer mt-2
                        hover:bg-blue-800"
